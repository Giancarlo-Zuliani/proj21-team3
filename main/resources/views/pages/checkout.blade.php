...
@section('content')
{{-- CART FOR SMARTPHONE WIDTH --}}
  <div id="checkoutcart" class=" col-lg-5 text-center">
    <div class= "stick-min-width">
      <div class="card shadow">
        ...
        <div id="carttotal">
          ...
          <h5 class="font-weight-bold">{{$fixedPrice}}€</h5>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container col-lg-11">
    <div  class="row col-xs-12 col-md-12">  
      {{-- FORM PAYMENT --}}
      <form method="post" id="payment-form" class="payment-checkout-form col-xs-12 col-sm-12 col-md-12 col-lg-5" action="{{  route('checkout') }}">
        <h1 class="my-4"><strong>Informazioni di contatto</strong></h1>
        @csrf
        @method('post')
        <div>
